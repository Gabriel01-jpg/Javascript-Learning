...
function () {
  ...
  _createClass(GeraCPF, [{
    ...
    value: function rand() {
      ...
      var cpfSorteado = Math.floor(Math.random() * (max - min) + min);
      return String(cpfSorteado);
    }
  }, {
    key: "geraDigitos",
    value: function geraDigitos() {
      var novoCPF = this.rand();
      var digito1 = _validaCPF__WEBPACK_IMPORTED_MODULE_0__["default"].retornaDigito(novoCPF);
      var adicionaDigito = novoCPF + digito1;
      var digito2 = _validaCPF__WEBPACK_IMPORTED_MODULE_0__["default"].retornaDigito(adicionaDigito);
...
function () {
  ...
  _createClass(ValidaCPF, [{
    ...
    value: function geraNovoCPF() {
      ...
      var digito1 = ValidaCPF.retornaDigito(cpfSemDigitos);
      var digito2 = ValidaCPF.retornaDigito(cpfSemDigitos + digito1);
    ...
    key: "retornaDigito",
    value: function retornaDigito(cpfParcial) {
      var total = 0;
      ...
      try {
        for (var _iterator = cpfParcial[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
